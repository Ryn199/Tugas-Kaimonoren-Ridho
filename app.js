...
//mengambil fungsi route mahasiswa
const kaimonorenRouter = require('./routes/kaimonoren');
...
// Menggunakan routes untuk rute kaimonoren
app.use('/kaimonoren', kaimonorenRouter);
